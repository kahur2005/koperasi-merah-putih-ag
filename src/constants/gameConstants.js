...
export const FURNITURE = {
  ...
  lpgStack:       { price: 400_000,  stockBonus: { lpgGas: 10 },            maxCount: Infinity, label: 'Gas LPG' },
  ...
  prabowoPicture: { price: 600_000,  happinessBonus: 10,                    maxCount: 3, label: 'Foto Presiden RI' },
  gibranPicture:  { price: 500_000,  happinessBonus: 10,                    maxCount: 3, label: 'Foto Wapres RI' },
};
